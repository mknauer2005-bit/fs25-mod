...
-- @return array deformationObjects
...
-- @param TerrainDeformation deformationObject instance
-- @param table area Table which holds area nodes, {start=origin node, width=first side area delimiter node, height=second side area delimiter node}
-- @param integer terrainBrushId Terrain brush ID, currently this is a map layer index (zero-based)
-- @param boolean writeBlockedAreaMap
...
---
-- @return boolean requiresLeveling
...
---
-- @return boolean realignAfterLeveling
