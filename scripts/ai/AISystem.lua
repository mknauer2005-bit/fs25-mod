...
-- If blocking is enabled and an agent crosses the region it will wait <stopDistance> meters in front of the region and the invoke the callback function continously
-- Debug rendering is enabled via enableVehicleNavigationMapDebugRendering (included in console command gsAIObstaclesShow)
-- @param float x
-- @param float y
-- @param float z
-- @param float rx
...
-- @param float sizeY
-- @param float sizeZ
-- @param float stopDistance
-- @param string callbackFuncName callback(entityId navMapId, entityId agentId, integer blockingRegionId), periodically called when agent is overlapping or waiting at the blocking region
-- @param table? callbackTarget
-- @return integer? blockingRegionId
...
---
-- @param integer blockingRegionId
...
---
-- @param integer blockingRegionId
-- @param boolean isBlocking if true agents will be blocked by the region and wait in front of it
