...
-- @return boolean hasLicensePlates has license plates
...
-- @return string defaultPlacementIndex default placement
-- @return boolean hasFrontPlate has front license plate
