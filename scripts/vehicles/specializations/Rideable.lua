...
-- @param integer left leg node
-- @param integer right leg node
-- @return float distance from root node
...
-- @return boolean returns true object that was hit is valid
...
-- @param table self instance
-- @param string actionName action name
-- @param float inputValue input value
-- @param string callbackState
-- @param boolean isAnalog true if input is analog
