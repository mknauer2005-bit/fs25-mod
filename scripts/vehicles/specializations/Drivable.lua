...
-- @param float speed new max speed
-- @param float speedReverse new max reverse speed
...
-- @return float cruiseControlSpeed current cruise control speed
-- @return boolean isActive is cruise control active
...
-- @return boolean isAllowed control is allowed
-- @return string warning warning text to display
...
-- @param float axisForward axis forward value
-- @param boolean axisForwardIsAnalog forward axis is analog
-- @param float axisSide side axis
-- @param boolean axisSideIsAnalog side axis is analog
-- @param boolean doHandbrake do handbrake
-- @param float dt time since lsat call in ms
