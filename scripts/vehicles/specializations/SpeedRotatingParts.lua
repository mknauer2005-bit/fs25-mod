...
-- @param table speedRotatingPart speed rotating part
    ...
    if isPartActive then
        ...
        elseif speedRotatingPart.wheels ~= nil then
            ...
            for i, wheel in ipairs(speedRotatingPart.wheels) do
                ...
                -- count wheel if it has ground contact or it's still rotating
                if (wheel.physics.contact ~= WheelContactType.NONE or math.abs(wheel.physics.netInfo.xDriveSpeed) > 0.01) or #speedRotatingPart.wheels == 1 then
