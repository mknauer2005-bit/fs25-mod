...
-- @param table animation animation
...
-- @param float animTime start time
...
-- @param string name name of animation
-- @return boolean exists animation axists
...
-- @param string name name of animation
-- @return table animation animation data
...
-- @param string name name of animation
-- @return boolean isPlaying animation is playing
...
-- @param string name name of animation
-- @return float animTime real animation time in ms
...
-- @param string name name of animation
-- @param float animTime real animation time in ms
-- @param boolean update update animation
...
-- @param string name name of animation
-- @return float animTime animation time [0..1]
...
---Set animation time
-- @param string name name of animation
-- @param float animTime animation time [0..1]
-- @param boolean update update animation
...
-- @param string name name of animation
-- @return float duration duration in ms
...
-- @param string name name of animation
-- @param float stopTime stop time [0..1]
...
-- @param table part part to reset
...
-- @param table a part a to check
-- @param table b part b to check
-- @return boolean rightOrder returns true if parts are in reverse right order
...
-- @param float destValue dest value
-- @param float speed speed
-- @param float dt time since last call in ms
-- @return float ret limited value
...
-- @param table currentValues current values
-- @param table destValues dest values
-- @param table speeds speeds
-- @param float dt time since last call in ms
...
-- @param table animation animation
-- @return integer index of current playing part
...
-- @param table part part
-- @param table anim animation
-- @return float duration duration to end of current part
...
-- @param table nextPart next part
-- @param table prevPart previous part
-- @param table anim animation
-- @param boolean default default value
-- @return boolean isPlaying next part is playing
...
-- @param string animName name of animation to update
-- @param float dt time since last call in ms
...
-- @return float dtToUse dt to use
-- @return boolean stopAnimation stop animation
...
---Update animation
-- @param table anim animation
-- @param float dtToUse dt to use
-- @param boolean stopAnimation stop animation
-- @param boolean fixedTimeUpdate is a fixed time update (e.g. from setAnimationTime) -> no sound, no looping, fixed setting between start and end values
-- @param playSounds playSounds if true it still plays sounds while doing fixed time updates
...
-- @param table anim animation
-- @param table part part
-- @param float durationToEnd duration to end
-- @param float dtToUse dt to use
-- @param float realDt real dt
