...
--#debug     local group, mask = getCollisionFilter(triggerNode)
--#debug     if group ~= colPreset.group then
--#debug         Logging.i3dWarning(triggerNode, "collision filter group for trigger does not match the 'FILL_TRIGGER' preset")
--#debug     end
--#debug     if mask ~= colPreset.mask then
--#debug         Logging.i3dWarning(triggerNode, "collision filter mask for trigger does not match the 'FILL_TRIGGER' preset")
--#debug     end
