...
-- @param string xmlPath xml path of the element the unloadTrigger element is located in
-- @param string? customEnvironment
-- @param string? baseDir
-- @return table? fillTypeNames set of fillTypeNames supported by the unload trigger (or one of its variations such as pallet trigger)
function UnloadTrigger.loadSpecValueFillTypes(xmlFile, xmlPath, customEnvironment, baseDir) end
