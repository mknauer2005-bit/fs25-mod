...
function InputHelpDisplay:draw(offsetX, offsetY)
    ...
    table.sort(self.infoExtensions, function(a, b)
        ...
        if a.vehicle ~= nil and b.vehicle ~= nil and a.vehicle.lastDistanceToCamera ~= nil and b.vehicle.lastDistanceToCamera ~= nil then
    ...
    for k, extension in pairs(self.helpExtensions) do
        -- for hud extensions we only cut off the VERY_LOW prio ones if we don't have enough space
