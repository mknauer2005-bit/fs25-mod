...
-- @param string prefix for this texture config file, is used in front of slice id when creating overlays
-- @param string? customEnv custom environment for mod namespace
...
-- @param string? customEnv needed for mod support
-- @return table? metadata {filename=string, imageSize={width, height}}
