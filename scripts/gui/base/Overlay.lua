...
-- @param string? overlayFilename File path of the source texture
-- @param float x Screen position x
-- @param float y Screen position y
-- @param float width Display width
-- @param float height Display height
...
-- @param array uvs UV coordinates in the form of {u1, v1, u2, v2, u3, v3, u4, v4}
...
-- @param float? width screenspace width [0..1]
-- @param float? height screenspace width [0..1]
...
-- @param boolean invertX If true, will set the overlay to display its image flipped horizontally
...
-- @param integer? vertical Vertical alignment value, one of Overlay.ALIGN_VERTICAL_[...]
-- @param integer? horizontal Horizontal alignment value, one of Overlay.ALIGN_HORIZONTAL_[...]
...
-- @param string overlayFilename File path to new target image
