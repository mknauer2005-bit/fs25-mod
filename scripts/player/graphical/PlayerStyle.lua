...
---Copies the selection and configuration from the given style. If the given style has no loaded configuration, this style will be marked as dirty.
-- @param PlayerStyle other The style to copy from.
...
-- If the configuration for this style has not been loaded or the given style is for a different configuration, this style's configuration will be marked dirty.
-- @param PlayerStyle other The style to copy from.
